...
public class InstanceController {
        ...
        public String getData(PushService.PushClient client) {
            ...
            try {
                result = doSrvIpxt(client.getNamespaceId(), client.getServiceName(), client.getAgent(),
                        ...
                        StringUtils.EMPTY, false, StringUtils.EMPTY, StringUtils.EMPTY, false, false);
            } catch (Exception e) {
    ...
    public ObjectNode doSrvIpxt(String namespaceId, String serviceName, String agent, String clusters, String clientIP,
            int udpPort, String env, boolean isCheck, String app, String tid, boolean healthyOnly, boolean enableOnly) throws Exception {
